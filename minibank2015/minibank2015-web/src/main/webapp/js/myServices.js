...
comptesServices.factory('Compte', ['$resource',
		...
		return $resource('pages/services/rest/json/comptes/:idRes' /*default url*/, {  idRes:'@numero' } /*default params */, {		
			       doVirement : { url : 'pages/services/rest/json/comptes/virement' /*redifined url */, method:'POST'},
	           });
	       }   
]);
...
comptesServices.factory('Transfert', ['$resource',
          ...
          return $resource('pages/services/rest/json/comptes/virement:idRes' /*default url*/, {  } /*default params */, {		
